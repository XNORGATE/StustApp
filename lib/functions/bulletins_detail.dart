...
class BulletinsDetailPage extends StatefulWidget {
  const BulletinsDetailPage({Key? key}) : super(key: key);

  static const routeName = '/bulletins-detail';

  @override
  // ignore: library_private_types_in_public_api
  _BulletinsDetailPageState createState() => _BulletinsDetailPageState();
}

class _BulletinsDetailPageState extends State<BulletinsDetailPage> {
  late String topic;
  late String src;
  late String href;
  late String account;
